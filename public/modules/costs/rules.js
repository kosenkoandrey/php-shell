    ...
    var methods = {
        ...
        getRulesListByLogic: function(logic) {
            return [
                ...
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="utm_campaign" href="javascript:void(0)">UTM-campaign</a></li>',
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="utm_term" href="javascript:void(0)">UTM-term</a></li>',
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="utm_content" href="javascript:void(0)">UTM-content</a></li>',
            ].join('');
        },
