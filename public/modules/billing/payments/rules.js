...
(function($) {
    var methods = {
        ...
        getRulesListByLogic: function(logic) {
            return [
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="invoice" href="javascript:void(0)">Invoice</a></li>',
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="method" href="javascript:void(0)">Method</a></li>'
            ].join('');
        },
    ...
    $.fn.BillingPaymentsRules = function(method) {
        if (methods[method]) {
            return methods[method].apply(this, Array.prototype.slice.call(arguments, 1));
        } else if (typeof method === 'object' || ! method) {
            return methods.init.apply(this, arguments);
        } else {
            $.error('BillingPaymentsRules: Unknown method: ' +  method);
        }
    };
})(jQuery);