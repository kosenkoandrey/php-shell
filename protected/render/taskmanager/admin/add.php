    ...
    <body data-ma-header="teal">
        ...
        <section id="main">
            ...
            <section id="content">
                <div class="container">
                    <div class="card">
                        <form id="add-task" class="form-horizontal" role="form">
                            ...
                            <div class="card-body card-padding">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="fg-line">
                                            <input type="text" class="form-control" name="args" id="args" value="[]">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#add-task').submit(function(event) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '<?= APP::Module('Routing')->root ?>admin/taskmanager/api/add.json',
                        data: $(this).serialize(),
                        success: function(result) {
                            ...
                            $('#add-task').find('[type="submit"]').html('Add').attr('disabled', false);
                        }
                    });
                  });
            });
