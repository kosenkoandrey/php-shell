...
<html lang="ru">
  <head>
    ...
    <body>
        <div id="final">
            <div class="center">
                Спасибо за внимание!<br>Голосование завершилось.<br><br>Победители будут объявлены в пятницу, 23 декабря в 17:00 МСК в прямом эфире по ссылке:
                <br><br>
                <a href="http://www.glamurnenko.ru/products/online-iqv61HwXl70.php" class="btn btn-success btn-lg btn-block">ПРЯМОЙ ЭФИР С ВЫБОРОМ ПОБЕДИТЕЛЯ</a>
                <br>
                Также во время прямого эфира мы проведем: 
                <ul>
                <li>розыгрыш наших тренингов среди всех участников конкурсов
        ...
        $(function() {
            ...
            function getpeople() {
                ...
                $.ajax({
                    type: 'post',
                    url: '<?= APP::Module('Routing')->root ?>hotornot/people/api/get_beta.json',
