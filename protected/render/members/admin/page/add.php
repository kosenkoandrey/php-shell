    ...
    <body data-ma-header="teal">
        ...
        <section id="main">
            ...
            <section id="content">
                <div class="container">
                    <div class="card">
                        <form id="add-page" class="form-horizontal" role="form">
                            ...
                            <div class="card-body card-padding">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="fg-line">
                                            <textarea name="content" id="html" class="form-control" placeholder="Write HTML version of the page"></textarea>
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#add-page').submit(function(event) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '<?= APP::Module('Routing')->root ?>admin/members/api/pages/add.json',
                        data: $(this).serialize(),
                        success: function(result) {
                            switch(result.status) {
                                case 'success':
                                    swal({
                                        title: 'Done!',
                                        text: 'Page "' + title.val() + '" has been added',
                                        type: 'success',
                                        showCancelButton: false,
                                        confirmButtonText: 'Ok',
                                        closeOnConfirm: false
                            ...
                            $('#add-page').find('[type="submit"]').html('Add').attr('disabled', false);
                        }
                    });
                  });
            });
