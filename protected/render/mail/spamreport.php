...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
        ...
        <title>PHP-shell - Spamreport</title>
    ...
    <body data-ma-header="teal">
        <? APP::Render('admin/widgets/header', 'include', [
            'Spamreport' => 'mail/spamreport/' . APP::Module('Routing')->get['mail_log_hash']
        ]) ?>
        <section id="main" class="center">
            <section id="content">
                <div class="container">
                    <div class="card">
                    <? if($data['result']) { ?>
                        <div class="card-header"><h2>Вы успешно отписаны от рассылок</h2></div>
                    <? }else{ ?>
                        <div class="card-header"><h2>Неверная ссылка на жалобу</h2></div>
