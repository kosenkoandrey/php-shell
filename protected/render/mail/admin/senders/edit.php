    ...
    <body data-ma-header="teal">
        ...
        <section id="main">
            ...
            <section id="content">
                <div class="container">
                    <div class="card">
                        <form id="edit-sender" class="form-horizontal" role="form">
                        ...
                        success: function(result) {
                            switch(result.status) {
                                case 'success':
                                    swal({
                                        title: 'Done!',
                                        text: 'Sender "' + name.val() + '" has been updated',
                                        type: 'success',
                            ...
                            $('#edit-sender').find('[type="submit"]').html('Save changes').attr('disabled', false);
                        }
                    });
                  });
            });
