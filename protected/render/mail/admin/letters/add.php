                        ...
                        <form id="add-letter" class="form-horizontal" role="form">
                            ...
                            <div class="card-body card-padding">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="fg-line">
                                            <textarea name="html" id="html" class="form-control auto-size" placeholder="Write HTML version of the letter"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="fg-line">
                                            <textarea name="plaintext" id="plaintext" class="form-control auto-size" placeholder="Write plaintext version of the letter"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        success: function(result) {
                            switch(result.status) {
                                case 'success':
                                    swal({
                                        title: 'Done!',
                                        text: 'Letter "' + subject.val() + '" has been added',
                                        type: 'success',
                                        showCancelButton: false,
                                        confirmButtonText: 'Ok',
                                        closeOnConfirm: false
                            ...
                            $('#add-letter').find('[type="submit"]').html('Add').attr('disabled', false);
                        }
                    });
                  });
            });
