    ...
    <body data-ma-header="teal">
        ...
        <section id="main">
            ...
            <section id="content">
                <div class="container">
                    <div class="card">
                        <form id="add-group" class="form-horizontal" role="form">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#add-group').submit(function(event) {
                    ...
                    $(this).find('[type="submit"]').html('Создание...').attr('disabled', true);

                    $.ajax({
                        type: 'post',
                        url: '<?= APP::Module('Routing')->root ?>admin/groups/api/create.json',
                        data: $(this).serialize(),
                        success: function(result) {
                            ...
                            $('#add-group').find('[type="submit"]').html('Создать').attr('disabled', false);
                        }
                    });
                  });
            });
