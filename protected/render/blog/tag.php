...
<head>
    <title><?= APP::Module('Routing')->get['tag'] ?></title>

    <!-- Meta -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Posts by tag - <?= APP::Module('Routing')->get['tag'] ?>">
    <meta name="keywords" content="<?= APP::Module('Routing')->get['tag'] ?>">
...
<div class="wrapper">
    ...
    <div class="breadcrumbs breadcrumbs-light">
        <div class="container">
            <h1 class="pull-left"><?= APP::Module('Routing')->get['tag'] ?></h1>
        </div>
    </div><!--/breadcrumbs-->
    <!--=== End Breadcrumbs ===-->
    ...
    <div class="container content-sm">
        <div class="row">
            <div class="col-md-9 md-margin-bottom-50">
                <!-- Blog Grid -->
                <?
                if (count($data['tag_articles'])) {
                    foreach ($data['tag_articles'] as $item) { 
                        ?>
