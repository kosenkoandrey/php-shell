    ...
    <body data-ma-header="teal">
        ...
        <section id="main">
            ...
            <section id="content">
                <div class="container">
                    <div class="card">
                        <form id="edit-connection" class="form-horizontal" role="form">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#port').val('<?= $data[1] ?>');
                $('#user').val('<?= $data[2] ?>');
                $('#password').val('<?= htmlspecialchars(APP::Module('Crypt')->Decode($data[3])) ?>');
                ...
                $('#edit-connection').submit(function(event) {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            $('#edit-connection').find('[type="submit"]').html('Save changes').attr('disabled', false);
                        }
                    });
                  });
            });
