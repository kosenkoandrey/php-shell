                            ...
                            <ul class="actions">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="<?= APP::Module('Routing')->root ?>admin/comments/objects/add">Add object</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
        ...
        <script>
            $(document).ready(function() {
                var objects_table = $("#objects-table").bootgrid({
                    ...
                    url: '<?= APP::Module('Routing')->root ?>admin/comments/api/objects/list.json',
                    css: {
                        icon: 'zmdi icon',
                    ...
                    formatters: {
                        actions: function(column, row) {
                            return  '<a href="<?= APP::Module('Routing')->root ?>admin/comments/objects/edit/' + row.token + '" class="btn btn-sm btn-default btn-icon waves-effect waves-circle"><span class="zmdi zmdi-edit"></span></a> ' + 
                    ...
                    objects_table.find('.remove-object').on('click', function (e) {
                        ...
                        swal({
                            ...
                            if (isConfirm) {
                                $.post('<?= APP::Module('Routing')->root ?>admin/comments/api/objects/remove.json', {
                                    id: object_id
                                }, function() { 
