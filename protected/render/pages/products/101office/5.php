	...
	<div class="block15" id="point5">
		<div class="ins">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td class="td1"><span class="sp1">Итого</span></td>
					<td class="td2"><span class="sp2">9 900 руб</span></td>
				</tr>
				<tr>
					<td class="td1"></td>
					<td class="td2"><a href="http://www.glamurnenko.ru/orders/order1.php?token=Pr026LeXs01Eu-UwE8KLDMHQ3cYzdh5a59bkbmZ9MG4&tr_e=<?= $user['email'] ?>" class="btn"  target="_blank"></a></td>
				</tr>
			</table>
			<div class="note1"></div>
		</div>
