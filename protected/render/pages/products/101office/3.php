		...
		<div class="ins">
			...
			<div class="item i7">
				...
				<div class="right" style="padding-top: 40px;">
					<div class="name">Как определить свой цветотип и цвета, которые вам идут</div>
					<p>На тренинге “101 рецепт стильного гардероба в офис” вы узнаете рецепты стильных образов в офис. Но как правильно выбрать цвета для этих комплектов, которые идут именно вам? В этом вопросе вам поможет разобраться бонусный семинар “Как определить свой цветотип и цвета, которые вам идут”</p>
					<p>Из этого семинара вы узнаете:<br>
- как определить свой цветотип<br>
