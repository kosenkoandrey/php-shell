...
<link rel="stylesheet" href="<?= APP::Module('Routing')->root ?>public/modules/pages/products/bigcolor/form/style_form.css">
...
<body>
  <div class="wrap">
    <div class="optin animated fadeInDown">
      <h1 ql-id="headline" ql-name="Headline" ql-editable="text">Запишитесь в предварительный список, чтобы получить скидку на Большой Тренинг по Цвету</h1>
