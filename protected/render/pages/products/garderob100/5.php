			...
			<div class="bl3">
				...
				<table border="0" cellspacing="0" cellpadding="0">
					...
					<tr class="tr4">
						...
						<td class="td4 last">9900 руб.</td>
					</tr>
					<tr class="tr5">
						<td class="td1"></td>
						<td class="td4 last"><a href="http://www.glamurnenko.ru/orders/order1.php?token=c71_LLn1RyYmMTSy8frp-o6YB8tUFzs5IQmMAnnHi5Y&tr_e=<?= $user_email ?>"></a></td>
					</tr>
				</table>
			</div>
