...
<head>
   ...
   <link rel="stylesheet" href="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/flashtimer/compiled/flipclock.css">
   <script src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/flashtimer/compiled/flipclock.js"></script>
...
<div class="bonus1" style="background:url('<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/bonus1.jpg') center top no-repeat; background-color:#189ed2;" id="sc10">
	<div class="bl_name">БОНУСЫ ДЛЯ УЧАСТНИКОВ ТРЕНИНГА</div>
	<div class="case">
		<div class="box"><img src="http://www.glamurnenko.ru/images/coverfw_1.png" alt=""></div>
		<div class="bonus_name">Бонус 1. “Тенденции сезона осень-зима 2016-2017 и как их применить для вашего гардероба”</div>
		<div class="bonus_descr">
			Из этого видео:<br>
			<ul style="margin-bottom: 10px;">
				<li><span>&raquo;</span>&nbsp;&nbsp;- вы узнаете, какие тенденции актуальны в сезоне осень-зима 2016-2017;</li>
				<li><span>&raquo;</span>&nbsp;&nbsp;- вы изучите актуальные цвета, фасоны, фактуры, компановки в костюмный ансамбль и узнаете, как применить их к своему гардеробу;
</li>
				<li><span>&raquo;</span>&nbsp;&nbsp;- сможете выбрать из них то, что подходит именно вам;</li>
...
<div class="bonus2" style="background:url('<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/bonus2.jpg') center top no-repeat; background-color:#eee;">
	<div class="bl_name"></div>
	<div class="case">
		<div class="box"><img src="http://www.glamurnenko.ru/images/coverfw_2.png" alt=""></div>
		<div class="bonus_name">Бонус 2. “Обувь и аксессуары сезона осень-зима 2016-2017”</div>
		<div class="bonus_descr">
...
- какие украшения, головные уборы, платки и шарфы станут изюминкой вашего гардероба в этом сезоне.</p>
		</div>
	</div>
	<div class="bl_name"></div>
</div>

<div class="bonus3" style="background:url('<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/bonus3.jpg') center top no-repeat; background-color:#eee;">
	<div class="bl_name"></div>
	<div class="case">
		<div class="box"><img src="http://www.glamurnenko.ru/images/coverfw_3.png" alt=""></div>
		<div class="bonus_name">Бонус 3. “MUST HAVE сезона осень-зима 2016-2017. 10 вещей, которые добавят изюминку вашему гардеробу”</div>
		<div class="bonus_descr">
			<p>На этом семинаре вы узнаете о том минимуме, который - ну, просто необходимо купить в этом сезоне, чтобы освежить свой гардероб!<br><br>

Я расскажу вам, каким образом вписать эти вещи в уже имеющийся гардероб так, чтобы сделать его более "острым", стильным и актуальным, но при этом не стать жертвой моды. </p>
		</div>
	</div>
	<div class="bl_name"></div>
</div>

<div class="bonus1" style="background:url('<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/bonus1.jpg') center top no-repeat; background-color:#eee;">
	<div class="bl_name"></div>
	<div class="case">
		<div class="box"><img src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/box4.png" alt=""/></div>
		<div class="bonus_name">Бонус 4. “Как определить свой цветотип и цвета базовых и расходных вещей, которые вам идут”</div>
		<div class="bonus_descr">
...
<div class="bonus2" style="background:url('<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/bonus2.jpg') center top no-repeat; background-color:#eee;">
	<div class="bl_name"></div>
	<div class="case">
		<div class="box"><img src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/box5.png" alt=""/></div>
		<div class="bonus_name">Бонус 5. “Для тех, кому за… <br>и размер одежды далек от 42-го”</div>
		<div class="bonus_descr">
...
<div class="bonus3" style="background:url('<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/bonus3.jpg') center top no-repeat; background-color:#eee;">
	<div class="bl_name"></div>
	<div class="case">
		<div class="box"><img src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/box6.png" alt=""/></div>
		<div class="bonus_name">Бонус 6. “Идеи базовых и расходных вещей для вашего гардероба на примере лучших витрин Милана”</div>
		<div class="bonus_descr">
			...
			<div class="bl3">
				...
				<table border="0" cellspacing="0" cellpadding="0">
					...
					<tr class="tr3">
						...
						<td class="td4 last"><img src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/yes.png" alt=""/></td>
					</tr>
					<tr class="tr3">
						<td class="td1">Проверка ДЗ в течении 2 месяцев<br>
					...
					<tr class="tr3">
						<td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Видео-семинар "Как преобразить ваш гардероб - Тенденции сезона осень-зима 2016-2017 и как их применить для вашего гардероба"</td>
						<td class="td4 last"><img src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/yes.png" alt=""/></td>
					</tr>
					<tr class="tr3">
						<td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Видео-семинар "Как преобразить ваш гардероб - Обувь и аксессуары сезона осень-зима 2016-2017"</td>
						<td class="td4 last"><img src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/yes.png" alt=""/></td>
					</tr>
					<tr class="tr3">
						<td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Видео-семинар "MUST HAVE сезона осень-зима 2016-2017. 10 вещей, которые добавят изюминку вашему гардеробу"</td>
						<td class="td4 last"><img src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/yes.png" alt=""/></td>
					</tr>
					<tr class="tr3">
						<td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Видео-семинар "Как определить свой цветотип и цвета базовых и расходных вещей, которые вам идут"</td>
						<td class="td4 last"><img src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/yes.png" alt=""/></td>
					</tr>
					<tr class="tr3">
					...
					<tr class="tr3">
						<td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Видео-семинар "Для тех, кому за… и размер одежды далек от 42-го"</td>
						<td class="td4 last"><img src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/yes.png" alt=""/></td>
					</tr>
					<tr class="tr3">
						<td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Видео-семинар "Идеи базовых и расходных вещей для вашего гардероба на примере лучших витрин Милана"</td>
						<td class="td4 last"><img src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/yes.png" alt=""/></td>
					</tr>

					<tr class="tr3">
						<td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Семинары по персональному имиджу</td>
						<td class="td4 last">5 на выбор</td>
					</tr>
					<tr>
						<td></td>
						<td class="last"></td>
					...
					<tr class="tr3">
						<td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Стандартная цена</td>
						<td class="td4 last"><s>9900 руб.</s></td>
					</tr>
					<tr class="tr4">
						<td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Ваша цена</td>
						<td class="td4 last">4900 руб.</td>
					</tr>
					<tr class="tr5">
						<td class="td1"></td>
						<td class="td4 last"><a href="http://www.glamurnenko.ru/orders/order1.php?token=G6-MtiYCQb0ehdld6SyDQ70LddIbsdkwIXQrPPNqhMc&tr_e=<?= $user_email ?>"></a></td>
					</tr>
				</table>
			</div>
