            ...
            <div class="l-block" id="l-login">
                ...
                <div class="lb-body">
                    ...
                    if ((int) APP::Module('Registry')->Get('module_users_login_service')) {
                        ?>
                        <form id="login">
                            <? if (!empty($data['social_networks']['module_users_social_auth_vk_id'])) { ?><a class="m-b-25 m-r-5 m-t-5 btn btn-default btn-icon waves-effect waves-circle waves-float" href="http://oauth.vk.com/authorize?<?= urldecode(http_build_query(['client_id' => $data['social_networks']['module_users_social_auth_vk_id'], 'redirect_uri'  => APP::Module('Routing')->root . 'users/login/vk', 'response_type' => 'code', 'scope' => 'email', 'state' => APP::Module('Crypt')->SafeB64Encode('{"return": "' . APP::Module('Crypt')->Encode($return) . '"}')])) ?>"><i class="zmdi zmdi-vk"></i></a><? } ?>
                            <? if (!empty($data['social_networks']['module_users_social_auth_fb_id'])) { ?><a class="m-b-25 m-r-5 m-t-5 btn btn-default btn-icon waves-effect waves-circle waves-float" href="https://www.facebook.com/dialog/oauth?<?= urldecode(http_build_query(['client_id' => $data['social_networks']['module_users_social_auth_fb_id'], 'redirect_uri'  => APP::Module('Routing')->root . 'users/login/fb', 'response_type' => 'code', 'scope' => 'email', 'state' => APP::Module('Crypt')->SafeB64Encode('{"return": "' . APP::Module('Crypt')->Encode($return) . '"}')])) ?>"><i class="zmdi zmdi-facebook"></i></a><? } ?>
                            <? if (!empty($data['social_networks']['module_users_social_auth_google_id'])) { ?><a class="m-b-25 m-r-5 m-t-5 btn btn-default btn-icon waves-effect waves-circle waves-float" href="https://accounts.google.com/o/oauth2/auth?<?= urldecode(http_build_query(['client_id' => $data['social_networks']['module_users_social_auth_google_id'], 'redirect_uri'  => APP::Module('Routing')->root . 'users/login/google', 'response_type' => 'code', 'scope' => urlencode('https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile'), 'state' => APP::Module('Crypt')->SafeB64Encode('{"return": "' . APP::Module('Crypt')->Encode($return) . '"}')])) ?>"><i class="zmdi zmdi-google-plus-box"></i></a><? } ?>
                            <? if (!empty($data['social_networks']['module_users_social_auth_ya_id'])) { ?><a class="m-b-25 m-r-5 m-t-5 btn btn-default btn-icon waves-effect waves-circle waves-float" href="https://oauth.yandex.ru/authorize?<?= urldecode(http_build_query(['client_id' => $data['social_networks']['module_users_social_auth_ya_id'], 'redirect_uri'  => APP::Module('Routing')->root . 'users/login/ya', 'response_type' => 'code', 'display' => 'popup', 'state' => APP::Module('Crypt')->SafeB64Encode('{"return": "' . APP::Module('Crypt')->Encode($return) . '"}')])) ?>"><i class="zmdi zmdi-twitter"></i></a><? } ?>
