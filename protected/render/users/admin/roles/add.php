    ...
    <body data-ma-header="teal">
        ...
        <section id="main">
            ...
            <section id="content">
                <div class="container">
                    <div class="card">
                        <form id="add-role" class="form-horizontal" role="form">
                        ...
                        success: function(result) {
                            switch(result.status) {
                                case 'success':
                                    swal({
                                        title: "Done!",
                                        text: 'Role "' + role.val() + '" has been added',
                                        type: "success",
                                ...
                                case 'error': 
                                    $.each(result.errors, function(i, error) {
                                        switch(error) {
                                            case 1: role.closest('.form-group').addClass('has-error has-feedback').find('.col-sm-3').append('<span class="zmdi zmdi-close form-control-feedback"></span><small class="help-block">Not specified</small>'); break;
                                        }
                                    });
                                    break;
                            }
