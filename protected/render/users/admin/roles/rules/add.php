...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    ...
    <body data-ma-header="teal">
        ...
        APP::Render('admin/widgets/header', 'include', [
            ...
            $data => 'admin/users/roles/rules/' . APP::Module('Routing')->get['role_id_hash']
        ]);
        ?>
        <section id="main">
            ...
            <section id="content">
                <div class="container">
                    <div class="card">
                        <form id="add-rule" class="form-horizontal" role="form">
                            ...
                            <div class="card-body card-padding">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="fg-line">
                                            <input type="text" class="form-control" name="uri_pattern" id="uri_pattern">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="fg-line">
                                            <input type="text" class="form-control" name="target" id="target" value="users/actions/login">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        success: function(result) {
                            switch(result.status) {
                                case 'success':
                                    swal({
                                        title: "Done!",
                                        text: 'Rule "' + uri_pattern.val() + '" has been added',
                                        type: "success",
                            ...
                            $('#add-rule').find('[type="submit"]').html('Add').attr('disabled', false);
                        }
                    });
                  });
            });
