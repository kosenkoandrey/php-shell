...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    ...
    <body data-ma-header="teal">
        ...
        APP::Render('admin/widgets/header', 'include', [
            'Answers' => 'admin/quiz/answer/'.APP::Module('Routing')->get['question_id_hash']
        ]);
        ?>
        <section id="main">
        ...
        <script>
            $(document).ready(function() {
                $('#id').val('<?= APP::Module('Routing')->get['answer_id_hash'] ?>');
                $('#text').val('<?= $data['text'] ?>');
                ...
                $('#update-quiz').submit(function(event) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '<?= APP::Module('Routing')->root ?>admin/quiz/api/answer/update.json',
                        data: $(this).serialize(),
                        success: function(result) {
                            ...
                            $('#update-answer').find('[type="submit"]').html('Save changes').attr('disabled', false);
                        }
                    });
                  });
            });
