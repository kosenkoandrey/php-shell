...
$db->query("
    ...
    `utm_source` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
    `utm_medium` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
    `utm_campaign` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
    `utm_term` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
    `utm_content` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
    `utm_compaing_desc` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
    `utm_content_desc` varchar(255) COLLATE utf8_unicode_ci NOT NULL
    ) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

    ALTER TABLE `costs`
    ADD PRIMARY KEY (`id`),
    ADD KEY `utm_source` (`utm_source`,`utm_medium`,`utm_campaign`),
