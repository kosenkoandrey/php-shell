...
$db->query('CREATE TABLE `letters` (`id` smallint(5) UNSIGNED NOT NULL, `group_id` smallint(5) UNSIGNED NOT NULL, `sender_id` smallint(5) UNSIGNED NOT NULL, `subject` varchar(100) COLLATE utf8_unicode_ci NOT NULL, `html` text COLLATE utf8_unicode_ci NOT NULL, `plaintext` text COLLATE utf8_unicode_ci NOT NULL, `list_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL, `up_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;');
$db->query('ALTER TABLE `letters` ADD PRIMARY KEY (`id`), ADD KEY `group_id` (`group_id`,`sender_id`,`list_id`), ADD KEY `group_id_2` (`group_id`), ADD KEY `sender_id` (`sender_id`);');
$db->query('ALTER TABLE `letters` MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;');
$db->query('ALTER TABLE `letters` ADD CONSTRAINT `letters_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `letters_groups` (`id`) ON DELETE CASCADE ON UPDATE CASCADE, ADD CONSTRAINT `letters_ibfk_2` FOREIGN KEY (`sender_id`) REFERENCES `senders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;');

$db->query('CREATE TABLE `letters_groups` (`id` smallint(5) UNSIGNED NOT NULL, `sub_id` smallint(5) NOT NULL DEFAULT "0", `name` varchar(100) COLLATE utf8_unicode_ci NOT NULL, `up_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;');
$db->query('INSERT INTO `letters_groups` (`id`, `sub_id`, `name`, `up_date`) VALUES (0, 0, "/", NOW());');
$db->query('ALTER TABLE `letters_groups` ADD PRIMARY KEY (`id`), ADD KEY `sub_id` (`sub_id`);');
$db->query('ALTER TABLE `letters_groups` MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;');

$db->query('CREATE TABLE `senders` (`id` smallint(5) UNSIGNED NOT NULL, `group_id` smallint(5) UNSIGNED NOT NULL, `name` varchar(100) COLLATE utf8_unicode_ci NOT NULL, `email` varchar(100) COLLATE utf8_unicode_ci NOT NULL, `up_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;');
$db->query('INSERT INTO `senders` (`id`, `group_id`, `name`, `email`, `up_date`) VALUES (1, 0, "' . $_SESSION['core']['install']['mail']['sender']['name'] . '", "' . $_SESSION['core']['install']['mail']['sender']['email'] . '", NOW())');
$db->query('ALTER TABLE `senders` ADD PRIMARY KEY (`id`), ADD KEY `group_id` (`group_id`);');
$db->query('ALTER TABLE `senders` MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;');
$db->query('ALTER TABLE `senders` ADD CONSTRAINT `senders_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `senders_groups` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;');

$db->query('CREATE TABLE `senders_groups` (`id` smallint(5) UNSIGNED NOT NULL, `sub_id` smallint(5) NOT NULL DEFAULT "0", `name` varchar(100) COLLATE utf8_unicode_ci NOT NULL, `up_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;');
$db->query('INSERT INTO `senders_groups` (`id`, `sub_id`, `name`, `up_date`) VALUES (0, 0, "/", NOW());');
$db->query('ALTER TABLE `senders_groups` ADD PRIMARY KEY (`id`), ADD KEY `sub_id` (`sub_id`);');
$db->query('ALTER TABLE `senders_groups` MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;');
...
APP::Module('Registry')->Add('module_mail_transport', '["default","Mail","Transport","admin/mail/settings"]');
...
APP::Module('Triggers')->Register('mail_remove_transport', 'Mail / Senders', 'Remove');
APP::Module('Triggers')->Register('mail_update_transport', 'Mail / Senders', 'Update');
